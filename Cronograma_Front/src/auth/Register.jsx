...
function Register() {
  ...
  const handleSubmit = async () => {
    const { nombre, correo, contrasena, repetirContrasena, empresa } = formData;

    if (!nombre || !correo || !contrasena || !repetirContrasena || !empresa) {
      Swal.fire({
        icon: 'warning',
  ...
  return (
    <div style={containerStyle}>
      <div className="container">
        <div className="row">
          {/* Imagen solo visible en pantallas md o más grandes */}
