...
public class Usuario {
    ...
    public Usuario(Integer idUsuario, String nombre, String correo, String contra, String empresa, LocalDateTime fechaRegistro, Boolean activo, Rol rol, List<Evento> eventos) {
